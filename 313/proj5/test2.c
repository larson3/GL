...
int main() {
   ...
   fp3 = new_frac() ;
	...
	/*I believe that the 0 0 2 which prints is correct as we are allocating
	space and never assigning, there should be a NULL there!*/
